...
from fastapi_cognito import CognitoAuth as _CognitoAuth
from fastapi_cognito import CognitoSettings, CognitoToken
...
class CognitoAuth(HTTPBearer):
    def __init__(self, settings: CognitoSettings):
        super().__init__()
        self.auth = _CognitoAuth(settings=settings, userpool_name="default")
